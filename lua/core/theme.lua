vim.cmd([[
  hi StatusLineNormal guifg=#ffffff guibg=#4C566A
  hi StatusLineInsert guifg=#ffffff guibg=#A3BE8C
  hi StatusLineVisual guifg=#ffffff guibg=#B48EAD
  hi StatusLineReplace guifg=#ffffff guibg=#BF616A
  hi StatusLineGit guifg=#EBCB8B guibg=#3B4252
