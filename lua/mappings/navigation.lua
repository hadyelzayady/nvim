...
map("n", "<leader>e", "<cmd>NvimTreeFindFileToggle<CR>", { desc = "File Tree" })
map("n", "<leader>E", "<cmd>NvimTreeFindFile<CR>", { desc = "File Tree" })
...
map("n", "<leader>ff", "<cmd>lua require('fzf-lua-frecency').frecency({ cwd_only = true,})<cr>", { desc = "Find Files" })
map("n", "<leader>f'", "<cmd>lua require('fzf-lua-frecency').frecency({ cwd_only = true,resume=true})<cr>", { desc = "Live Grep" })
